...
class BertEM(nn.Module):
    ...
    def forward(self, words):
        ...
        subj_mask = words.unsqueeze(2).eq(1)#torch.logical_and(words.unsqueeze(2).gt(0), words.unsqueeze(2).lt(3))
        obj_mask = words.unsqueeze(2).eq(3)#torch.logical_and(words.unsqueeze(2).gt(2), words.unsqueeze(2).lt(20))
